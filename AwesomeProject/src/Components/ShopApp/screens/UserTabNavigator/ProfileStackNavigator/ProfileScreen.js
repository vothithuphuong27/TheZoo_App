        ...
        <React.Fragment>
          ...
          <ScrollView
            ...
            <ListItem
              ...
              <ListItem.Title style={{marginHorizontal: -10, marginTop: 5}}>
                Đơn hàng
              </ListItem.Title>
            </ListItem>
            <ListItem
            ...
            <ListItem
              ...
              <ListItem.Title style={{marginHorizontal: -10, marginTop: 3}}>
                Sản phẩm yêu thích
              </ListItem.Title>
            </ListItem>
            <ListItem
          ...
          <View style={{padding: 12}}>
            <Button
              ...
              onPress={() => {
                ...
                firestore().collection('tempCarts').doc(uid).set({
